...
class Functions:
	...
	def __init__(self):
		...
		self.background_original=pygame.image.load('graphics/background1.jpg')
		self.background=pygame.transform.scale(self.background_original,(self.screen_width,self.screen_height))
		...
		self.lives = 3
		self.original = pygame.image.load('graphics/player.png').convert_alpha()
		self.live_surf=pygame.transform.scale(self.original,(30,30))
